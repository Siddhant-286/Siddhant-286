...
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/siddhant_tiwari_268)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/siddhant-tiwari-650160295/)
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:siddhanttiwari060@gmail.com)
...
Here are some of my key analytics projects (more on my GitHub repos):

- **UPI Transactions Dashboard**  
  Analyzed UPI payment transaction data to identify spending patterns, transaction frequency, and category-wise trends using Python, SQL, and dashboards (Power BI / Plotly).

- **Prism Insurance Analytics Dashboard**  
  Evaluated premium vs. claim amounts, claim settlement ratios, and policy profitability to support risk and pricing decisions.

- **Churn Analysis Dashboard**  
  Identified customer churn drivers and high-risk segments to support retention strategies.

- **ClimateScope (Infosys Springboard Internship)**  
  Built a climate analytics dashboard as part of a 2‑month data visualization internship, focusing on data storytelling and insights.
